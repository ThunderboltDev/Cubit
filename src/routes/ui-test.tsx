...
const buttonVariants = ["default", "outline", "ghost", "transparent"] as const;
const buttonThemes = [
	"default",
	"accent",
	"info",
...
const badgeSizes = ["default", "sm", "lg", "xl"] as const;
const badgeVariants = ["default", "outline", "transparent"] as const;
const badgeThemes = [
	"default",
	"accent",
	"info",
