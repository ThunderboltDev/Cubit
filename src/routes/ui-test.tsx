...
const buttonVariants = ["default", "ghost", "transparent"] as const;
const buttonThemes = [
  "default",
  "accent",
  "success",
...
const badgeSizes = ["default", "sm"] as const;
const badgeVariants = ["default", "transparent"] as const;
const badgeThemes = [
  "default",
  "accent",
  "success",
            ...
            {buttonThemes.map((theme) => (
              <div key={theme} className="mb-4">
                ...
                <div className="flex flex-wrap gap-4 items-center">
                  ...
                  <Button variant={variant} disabled theme={theme}>
                    Disabled
                  </Button>
                  <Button
                    variant={variant}
        ...
        {badgeVariants.map((variant) => (
          ...
          >
            {badgeThemes.map((theme) => (
              <div key={theme} className="mb-4 pr-4">
                <h4 className="text-sm font-medium mb-2 text-muted-foreground">
                  {theme.charAt(0).toUpperCase() + theme.slice(1)} Theme
                </h4>
          ...
          <FieldSet>
            ...
            <FieldGroup>
              <FieldItem orientation="horizontal" className="gap-2">
                ...
                <AlertDialog>
                  <AlertDialogTrigger variant="transparent" theme="danger">
                    Delete Account
                  </AlertDialogTrigger>
                  <AlertDialogContent>
                    <AlertDialogHeader>
