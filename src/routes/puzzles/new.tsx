				...
				{mode === "presets" ? (
					<div className="space-y-8">
						<div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4">
							{WCA_PRESETS.map((preset) => (
								<button
									...
									className="group relative flex flex-col items-center gap-4 rounded-xl border border-border bg-secondary p-6 text-center shadow-md transition-all hover:border-accent hover:shadow-lg active:scale-95 duration-250"
								>
									<div className="relative flex h-16 w-16 items-center justify-center rounded-lg bg-background shadow-sm group-hover:bg-accent/5 group-hover:scale-110 duration-250 transition-transform">
						...
						<div className="flex justify-center">
							<Button className="gap-2" onClick={() => setMode("custom")}>
