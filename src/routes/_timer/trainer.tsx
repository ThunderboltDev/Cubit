...
function FeatureCard({
  ...
  return (
    <motion.div variants={item}>
      <Card className="group relative h-full overflow-hidden border-none bg-accent/5 duration-200 hover:bg-accent/10 hover:shadow-xl hover:shadow-accent/10">
        <div className="relative z-10 flex flex-col p-6">
          <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-accent text-white shadow-lg shadow-accent/20 group-hover:scale-105 duration-200">
